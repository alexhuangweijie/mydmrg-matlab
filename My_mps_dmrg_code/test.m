...
J_1 = 0.5i*(t+delta);
J_2 = -0.5i*(t-delta);
Hloc2(5,2,:,:) = lambda_2*J_1;
Hloc2(5,3,:,:) = lambda_1*J_2;
Hloc2 = permute(Hloc2,[1 3 2 4]);% leg order: left-bottom-right-top
for itN = 2:2:N
    Hs(itN) = {Hloc2};
%     itN
end
